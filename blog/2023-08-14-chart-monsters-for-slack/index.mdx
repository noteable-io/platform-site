...
Sometimes it's hard to get people to read your notebook reports no matter how many times you post them. To solve this, we can push reports _directly_ to your colleagues in slack under the veneer of an adorable chart monster.
...
You can use Chartsworth to post plots and texts from your reports for colleagues to see. Set up a Slack App (detailed below) and install `chartsworth` to start posting!

Once you have chartsworth setup in your notebook, schedule it!
...
To make your chart monster, I recommend the following prompts for Midjourney or DALL-E 2:
...
4. Scheduling Notebooks in Noteable
