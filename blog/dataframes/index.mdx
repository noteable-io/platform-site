...
The rise of Jupyter Notebooks was powered in no small part by the power Pandas brought to tabular data handling. For data scientists, viewing the first few rows of a table is often the first step in even the most sophisticated approaches.
