...
title: "OpenAI Function Calling: Enabling Models to Manipulate Notebooks with Origami"
authors: [shoup]
...
As powerful as ChatGPT Plugins are, they have their own limitations. Our own design of the plugin is limited by what we can expose to the broad user base of ChatGPT users. You, however, are not limited if you're working with the API directly.
